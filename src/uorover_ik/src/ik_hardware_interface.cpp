...
class IKHardwareInterface : public rclcpp::Node
{
  public:
    IKHardwareInterface() : Node("HardwareInterface") {
        ...
        upstream_publisher_ = this->create_publisher<control_msgs::msg::JointTrajectoryControllerState>("joint_states", 10);
    ...
    void setReferencePositions(const std::vector<double> &referencePositions){
        ...
        tmp = referencePositions_[1];
        referencePositions_[1] = LA1_.lMin + LA1_.slope * (tmp - LA1_.thetaMin);
        tmp = referencePositions_[2];
        referencePositions_[2] = LA2_.lMax - LA2_.slope * (tmp - LA2_.thetaMin);
    } 
  ...
  private:
    ...
    rclcpp::Publisher<control_msgs::msg::JointTrajectoryControllerState>::SharedPtr upstream_publisher_;
